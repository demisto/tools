...
# batchutils
# A helper utility to do stuff on multiple incidents based on filter
#
...
def options_handler():
    ...
    parser.add_argument('-f', '--filter', help='The filter query to chose the alerts', default='(status:=0 or status:=1) and created:>%s' % format_dt(monthAgo))
